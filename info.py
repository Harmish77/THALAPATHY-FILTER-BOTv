...
URL = "https://moviehub-jjyz.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviehub-jjyz.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviehub-jjyz.onrender.com/".format(FQDN)
else:
    URL = "https://moviehub-jjyz.onrender.com/".format(FQDN)
